...
module.exports.author = (author) => {
    return Buffer.from(`
        <svg width="500" height="100" >
            <style>
            .author { fill: #001; font-family: Courier New; font-size: 2.5em; font-weight: bold; }
...
module.exports.title = (title) => {
    ...
    <svg width="720" height="100" >
      <style>
      .title { fill: #001; font-family: monospace; font-size: 2em; font-weight: bold; }
      </style>
        <text x="0" y="40" class="title" >${title}</text>
    </svg>
    `);
}
